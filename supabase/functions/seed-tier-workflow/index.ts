...
const FOUNDATION_STEPS = [
  ...
  // unlike SEO which gets a real audit immediately as step 2 above. Step
  // number 5 was an intentional gap (see file-top comment); nothing
  // depends_on it, so it's free to use.
