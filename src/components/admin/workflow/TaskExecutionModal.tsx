...
function mapTaskToJobType(taskName: string): string {
  const mappings: Record<string, string> = {
    ...
    "build landing pages": "build_landing_pages",
    "landing page pack": "build_landing_pages",
    "build website rebuild": "build_website_rebuild",
    "website rebuild": "build_website_rebuild",
    "full website rebuild": "build_website_rebuild",
    "run advanced seo": "run_advanced_seo",
    "advanced seo program": "run_advanced_seo",
    "create lead magnet": "create_lead_magnet",
    "lead magnet development": "create_lead_magnet",
    "build sales funnel": "build_sales_funnel",
    "full funnel buildout": "build_sales_funnel",
    "setup sales enablement": "setup_sales_enablement",
    "sales enablement system": "setup_sales_enablement",
    "schedule strategy call": "schedule_strategy_call",
    "monthly strategy call": "schedule_strategy_call",
    "optimize crm pipeline": "optimize_crm_pipeline",
    "crm pipeline optimization": "optimize_crm_pipeline",
    "create full analytics suite": "create_full_analytics_suite",
    "full analytics suite": "create_full_analytics_suite",
  };
