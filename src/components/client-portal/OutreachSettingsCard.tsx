  ...
  return (
    <Card className="border-0 bg-muted/30">
      <CardHeader>
        ...
        <CardDescription>
          Used to sign off and link out in every AI-drafted outreach email. Leave blank to sign as{" "}
          <strong>{"your business name"}</strong> and link to <strong>{fallbackUrl}</strong>.
        </CardDescription>
      </CardHeader>
