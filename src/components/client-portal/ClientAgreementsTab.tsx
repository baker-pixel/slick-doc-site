  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">View and download your active contracts and scope of work documents.</p>
      </div>
              ...
              <CardContent className="space-y-4">
                ...
                {agreement.file_url ? (
                  ...
                  >
                    ...
                    {downloading === agreement.id ? 'Downloading...' : 'Download Agreement'}
                  </Button>
                ) : (
